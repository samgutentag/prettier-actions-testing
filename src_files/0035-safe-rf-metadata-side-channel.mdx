...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Spreading factor component of LoRa DataRate (eg. "SF12"). Used only when modulation is
        "LORA".
      </td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        The UNIX timestamp (in milliseconds) when the message should be sent (when set to '0' means
        "immediately").
      </td>
    </tr>
    <tr>
      ...
      <td>
        The UNIX timestamp (in milliseconds) of the local system when the message should be sent
        (when set to '0' means "immediately").
      </td>
    </tr>
    <tr>
      <th>3</th>
